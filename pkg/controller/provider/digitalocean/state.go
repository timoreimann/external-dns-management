...
func toRecord(godoRecord godo.DomainRecord, domain string) *Record {
	return &Record{
		DomainRecord: godoRecord,
		domain: domain,
	}
}

func (r *Record) GetType() string    { return r.Type }
func (r *Record) GetId() string      { return strconv.Itoa(r.ID) }
func (r *Record) GetDNSName() string { return r.Name }
func (r *Record) GetValue() string {
	if r.Type == dns.RS_TXT {
		return raw.EnsureQuotedText(r.Data)
	}
	return r.Data
}
